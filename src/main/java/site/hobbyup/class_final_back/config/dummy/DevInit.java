        ...
        public CommandLineRunner dataSetting(UserRepository userRepository, CategoryRepository categoryRepository,
                ...
                return (args) -> {
                        ...
                        Profile profile1 = profileRepository
                                        .save(newProfile("", "ssar의 프로필입니다.", "부산진구", "ssar의 자격증입니다.",
                        ...
                        Profile profile4 = profileRepository
                                        .save(newProfile("", "hong의 프로필입니다.", "부산진구", "hong의 자격증입니다.",
                                                        "5년", "강남의 매장에서 10년간 점장으로 일함", hong));
                        Profile profile5 = profileRepository
                                        .save(newProfile("", "lala의 프로필입니다.", "부산진구", "lala의 자격증입니다.",
                        ...
                        Review review6 = reviewRepository
                                        .save(newReivew("이정도 퀄리티면 좋은 거 같아요, 다만 목소리가...", 3.5, cos, lesson4));
                        ...
                        Review review12 = reviewRepository
                                        .save(newReivew("이정도 퀄리티면 좋은 거 같아요, 다만 목소리가...", 3.5, hong, lesson15));
                        ...
                        Review review18 = reviewRepository
                                        .save(newReivew("이정도 퀄리티면 좋은 거 같아요, 다만 목소리가...", 3.5, cos, lesson32));
                        ...
                        Review review24 = reviewRepository
                                        .save(newReivew("이정도 퀄리티면 좋은 거 같아요, 다만 목소리가...", 3.5, cos, lesson48));
